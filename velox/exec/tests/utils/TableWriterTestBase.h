...
#include "velox/common/compression/CompressionKind.h"
#include <folly/dynamic.h>

namespace facebook::velox::exec::test {

class TableWriterTestBase : public OperatorTestBase {
 public:
  /// Creates a connector::common::ConnectorInsertTableHandle via the common factory, serializing
  /// HiveBucketProperty into options.
  static std::shared_ptr<connector::common::ConnectorInsertTableHandle> makeInsertTableHandle(
  ...
  /// Helper for TableWriter tests: packages Hive bucket‐property settings
  /// into a folly::dynamic.  Does not require Hive headers.
  static folly::dynamic makeBucketPropertyOptions(
      int32_t bucketCount,
...
//  connector::common::CommitStrategy commitStrategy_;
