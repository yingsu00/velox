...
struct IcebergField : public ISerializable {
  IcebergField(
      int32_t _fieldId,
      std::string _fieldName,
      std::vector<IcebergField> _children)
      : fieldId(_fieldId),
        fieldName(std::move(_fieldName)),
        children(std::move(_children)) {}

  bool operator==(const IcebergField& other) const {
  ...
  static std::unique_ptr<IcebergField> create(const folly::dynamic& obj);
 ...
 public:
  ...
  IcebergColumnHandle(
      ...
      : lakehouse::common::ColumnHandleBase(
        ...
        icebergField_(icebergField) {}

  IcebergField icebergField() const {
    return icebergField_;
  }
