...
TEST_F(IcebergColumnHandleTest, SerializeAndCreateRoundTrip_SimpleScalar) {
  ...
  IcebergField columnIdentity(10, "date", {});
...
TEST_F(
  ...
  // (id=4,"sku"))
  IcebergField id4(4, "sku", {});
  IcebergField id3(3, "items", {id4});
  IcebergField id2(2, "price", {});
  IcebergField columnIdentity(1, "order", {id2, id3});
