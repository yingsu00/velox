...
class HiveInsertTableHandle : public ConnectorInsertTableHandle {
 public:
  HiveInsertTableHandle(
      std::vector<std::shared_ptr<const ColumnHandleBase>> inputColumns,
  ...
  const std::vector<std::shared_ptr<const ColumnHandleBase>>& inputColumns()
      const {
 ...
 private:
  const std::vector<std::shared_ptr<const ColumnHandleBase>> inputColumns_;
