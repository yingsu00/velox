...
TEST_F(ComparisonsTest, eqNeqArray) {
  ...
  test(velox::common::testutil::optionalEmpty, velox::common::testutil::optionalEmpty, true);
  ...
  test(velox::common::testutil::optionalEmpty, {{std::nullopt, std::nullopt}}, false);
...
TEST_F(ComparisonsTest, eqNestedComplex) {
  ...
  array_type array2 = velox::common::testutil::optionalEmpty;
